...
const Card = () => {
  ...
  return (
    <Carousel
      ...
      containerClass="flex " // Adiciona espaçamento entre os cards
      itemClass="flex justify-center mx-4" // Centraliza os cards
    >
      {cardapios.map(cardapio => (
        <div
          key={cardapio.id}
          className="bg-white p-4 shadow-lg flex flex-col items-center w-[297px] min-w-[297px] h-[268px] min-h-[268px] mx-2" // Adiciona margem horizontal
        > 
