...
const ModalModaCasa = ({ isOpen, onRequestClose, contentLabel, pratoPrincipal, guarnicao, sobremesa, salada, dataCardapio, idCardapio, atualizarCardapio }) => {
...
const enviarInformacoes = async () => {
    const urlPost = "http://127.0.0.1:8080/modadacasa/cardapios";
    const urlPut = `http://127.0.0.1:8080/modadacasa/cardapios/${idCardapio}`;
           ...
           style={{ overflowY: "auto" }}>
            ...
            <div className="flex flex-col items-center w-full pt-[70px]">
              ...
              <form className="w-full flex flex-col px-[10px] md:px-[20px]" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className={`px-6 py-2 ${isLoading ? 'bg-gray-400' : 'bg-[#007BC0]'} text-white text-[15px] md:text-[17px] shadow-sm`}
                  disabled={isLoading}
                >
